...
#     print("Qeyd: Bizim sistem tam paralel qurulduğuna görə, ardıcıl vaxt bu üç API-nin tək-tək cavab vermə vaxtlarının cəminə bərabərdir.")
...
#     seq_duration = wikipedia_time + arxiv_time + tavily_time + llm_time
#     time.sleep(1) 
